package com.scfl.base.utils;

import com.scfl.base.enumerate.ModuleEnum;
import org.apache.commons.lang3.StringUtils;

import java.util.Objects;

public class CustomStringProcess {
    // 通用错误提示 (包含所有业务模块)
    public static final String SERVICE_PARAM_ERROR = "服务层传入参数错误！";
    ...
    public static final String ILLEGAL_PHONE = "手机号不合法！";
    ...
    protected static final String NOT_ASSGIN_VALUE_SECTION = "%s值不在指定的%s-%s区间内！";
