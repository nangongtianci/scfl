...
public class Generator {
    ...
    private static void generate(String model,String ... tableName){
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/dispatching_center?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull");
        ...
        strategy.setSuperEntityClass("com.scfl.base.entity.BaseEntity");
        ...
        pc.setParent("com.scfl.dispatching.center");
